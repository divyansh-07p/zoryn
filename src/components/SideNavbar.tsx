  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-20 left-4 z-40 lg:hidden bg-blue-500/20 border border-blue-400/30 p-2 rounded-lg hover:bg-blue-500/30 transition-all"
      >
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-16 glass-dark border-r border-blue-500/10 flex flex-col z-40 transition-all duration-300 ${
      ...
      >
        ...
        <div className="px-4 py-3 border-t border-blue-500/10 space-y-2 flex-shrink-0">
          ...
          {/* Logout Button */}
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-red-400 hover:bg-red-500/10 transition-all duration-300 border border-transparent hover:border-red-400/30">
            <LogOut size={20} />
